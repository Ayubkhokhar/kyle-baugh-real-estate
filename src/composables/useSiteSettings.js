...
export function getAgentDefaultSettings() {
  ...
  return {
    ...
    pedigreeTag: profile.pedigreeTag || "Advisory Pedigree",
    pedigreeHeading: profile.pedigreeHeading || "Structural Precision Meets Dallas Real Estate Discretion.",
    pedigreeImage: profile.pedigreeImage || "/images/compass/2007-euclid-avenue-cover.webp",
    pedigreeBadgeTitle: profile.pedigreeBadgeTitle || "Institutional Advisory Foundation",
